...
for i =1: length(unique(SessionData.Custom.BlockNumberL))

    CompletedTrials = ~isnan(SessionData.Custom.ChoiceLeft) & SessionData.Custom.BlockNumberL(1:end-1)==i;
